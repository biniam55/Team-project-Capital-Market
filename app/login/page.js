  ...
  return (
    sessionStatus !== "authenticated" && (
      <main className="flex sm-w-full flex-col items-center justify-between overflow-hidden  p-full lg:p-15  sm:h-[100vh]">
        <div
          id="login"
          className="bg-white flex flex-col-reverse lg:flex-row   shadow-2xl  flex w-600 lg:w-[1140px] h-100 lg:h-[700px] max-w-4xl"
        >
          ...
          >
            <div className="items-center font-poppins text-xl text-mycolor1 ml:50 lg:ml-10">
              <p className="items-center mt-5 lg:text-3xl ml-[5rem] md:ml-[13rem] lg:ml-[3rem]">
                Welcome Back
              </p>
