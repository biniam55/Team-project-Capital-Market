            ...
            <form onSubmit={handleSignUp}>
              <div className="flex flex-col items-center">
                <div className="bg-gray-100 rounded-2xl w-64 p-2 flex items-center mb-3 ">
                  ...
                  <input type="email" name="email" placeholder="Username/email" className="bg-gray-100 outline-none text-sm flex-1" />
                </div>
                <div className="bg-gray-100 rounded-2xl w-64 p-2 flex items-center mb-3 ">
                  <MdLockOutline className="text-gray-400 mr-2" />
                  <input type="password" name="password" placeholder="Password" className="bg-gray-100 outline-none text-sm flex-1" />
                </div>
                <button type="submit" className="border-2 border-mycolor-500 bg-mycolor text-mycolor1 rounded-full px-12 py-2 inline-block font-semibold hover:bg-mycolor-500 hover:text-white">
                  {" "}
                  Sign Up
                </button>
                ...
                <a href="https://www.facebook.com" className="bg-white border py-2 w-60 rounded-xl mt-5  flex justify-center items-center">
                  <svg className="mr-3" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" viewBox="0 0 48 48">
