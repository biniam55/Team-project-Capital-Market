...
const Navbar = () => {
  ...
  return (
    <div
      className={`w-full flex flex-row justify-between py-4 text-sm transition-all duration-200 px-8 ${scrolled && "bg-capital-purple md:px-[4rem] px-10"
        ...
        <ul className="flex nav-menu flex-col md:flex-row gap-8 justify-center items-center cursor-pointer h-[30vh] md:h-0">
          ...
          {!session ? (
            <>
              ...
              <li
                className={` bg-white md:bg-capital-purple border border-transparent text-black  px-5 py-1.5 text-center rounded-sm hover:border-white md:hover:text-gray-800 md:hover:bg-transparent md:hover:border-capital-purple transition-all duration-300 ease-in-out cursor-pointer ${scrolled
